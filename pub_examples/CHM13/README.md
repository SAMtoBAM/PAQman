...
### 2.A PacBio HiFi reads
    ...
    cat *.fastq | gzip > reads/pacbio/SRR9087XXX.pacbio.fq.gz
    ##remove uncompressed
    rm *.fastq
...
### 2.B ONT reads
    ...
    wget -qO- https://s3-us-west-2.amazonaws.com/human-pangenomics/T2T/CHM13/nanopore/rel8-guppy-5.0.7/reads.fastq.gz | gunzip -c | seqkit seq -m 7500 | seqkit head -l 75000000000 | gzip > reads/ont/rel8.25X_subset.ont.fq.gz
