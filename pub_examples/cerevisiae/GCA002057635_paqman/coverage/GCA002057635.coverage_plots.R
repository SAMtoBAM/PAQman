...
LRcoverage=read.csv(file="/mnt/cephfs/scratch/saodonnell/projects/genomeval/paqman_test_data/cerevisiae/GCA002057635_paqman.8t/coverage/GCA002057635.30kbwindow_10kbsliding.minimap.coverage_normalised.tsv", header=T, sep='\t' )
...
ggsave(filename = "./coverage/GCA002057635.LR.svg", plot = LRplot,
