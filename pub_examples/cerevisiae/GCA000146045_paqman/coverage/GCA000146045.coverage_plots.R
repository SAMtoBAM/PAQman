...
LRcoverage=read.csv(file="/mnt/cephfs/scratch/saodonnell/projects/genomeval/paqman_test_data/cerevisiae/GCA000146045_paqman.8t/coverage/GCA000146045.30kbwindow_10kbsliding.minimap.coverage_normalised.tsv", header=T, sep='\t' )
...
ggsave(filename = "./coverage/GCA000146045.LR.svg", plot = LRplot,
