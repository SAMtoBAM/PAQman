...
LRcoverage=read.csv(file="/mnt/cephfs/scratch/saodonnell/projects/genomeval/paqman_test_data/cerevisiae/GCA016858165_paqman.8t/coverage/GCA016858165.30kbwindow_10kbsliding.minimap.coverage_normalised.tsv", header=T, sep='\t' )
...
ggsave(filename = "./coverage/GCA016858165.LR.svg", plot = LRplot,
